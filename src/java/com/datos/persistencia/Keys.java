 ...
 */
package com.datos.persistencia;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<EstructuraRecord, IdiomasRecord> FK_IDIOMA_ESTRUCTURA = createForeignKey(com.datos.persistencia.Keys.KEY_IDIOMAS_PRIMARY, Estructura.ESTRUCTURA, Estructura.ESTRUCTURA.IDIOMAID);
		public static final ForeignKey<EstructurapalabrasRecord, TipospalabrasRecord> FK_ESTRUCTURASTIPOS = createForeignKey(com.datos.persistencia.Keys.KEY_TIPOSPALABRAS_PRIMARY, Estructurapalabras.ESTRUCTURAPALABRAS, Estructurapalabras.ESTRUCTURAPALABRAS.TIPOID);
		public static final ForeignKey<EstructurapalabrasRecord, EstructuraRecord> FK_PALABRASESTRUCTURAS = createForeignKey(com.datos.persistencia.Keys.KEY_ESTRUCTURA_PRIMARY, Estructurapalabras.ESTRUCTURAPALABRAS, Estructurapalabras.ESTRUCTURAPALABRAS.ESTRUCTURAID);
		public static final ForeignKey<PalabrasRecord, IdiomasRecord> FK_IDIOMASPALABRAS = createForeignKey(com.datos.persistencia.Keys.KEY_IDIOMAS_PRIMARY, Palabras.PALABRAS, Palabras.PALABRAS.IDIOMAID);
		public static final ForeignKey<PalabrasRecord, TipospalabrasRecord> FK_TIPOPALABRAS = createForeignKey(com.datos.persistencia.Keys.KEY_TIPOSPALABRAS_PRIMARY, Palabras.PALABRAS, Palabras.PALABRAS.TIPOID);
		public static final ForeignKey<PalabrasRecord, PalabrasRecord> FK_KEOEK = createForeignKey(com.datos.persistencia.Keys.KEY_PALABRAS_PRIMARY, Palabras.PALABRAS, Palabras.PALABRAS.PAL_PALABRAID);
		public static final ForeignKey<PalabrasRecord, TiemposRecord> FK_TIEMPOSPALABRAS = createForeignKey(com.datos.persistencia.Keys.KEY_TIEMPOS_PRIMARY, Palabras.PALABRAS, Palabras.PALABRAS.TIEMPOSID);
		public static final ForeignKey<UsuarioRecord, PersonasRecord> FK_PERSONAUSUARIO = createForeignKey(com.datos.persistencia.Keys.KEY_PERSONAS_PRIMARY, Usuario.USUARIO, Usuario.USUARIO.PERSONAID);
	}
}
